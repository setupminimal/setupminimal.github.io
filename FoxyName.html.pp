...
r_text[1] = "kind";
r_text[2] = "child";
r_text[3] = "beha (or -dottir or -sen)";
r_text[4] = "clan";
r_text[5] = "ovni (or -ovna or -ovitch)";
r_text[6] = "tribe";
r_text[7] = "sib (or -sister or -brother)";
r_text[8] = "one";
r_text[9] = "group";
r_text[10] = "friend";
r_text[11] = "offspring";
...
var l2 = r_text[i]
document.write(n1 + n2 + " Frances " + l1 + l2);
...
</br> I created the Foxy Society Name Generator a while ago for the <a href="http://knitchrochethogwartshousecup.blogspot.com/">HPKCHC</a>.
</br>
